    ...
    <div className="min-h-[calc(100vh-80px)] text-zinc-200 py-20 px-6 font-sans antialiased">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 drop-shadow-lg">About <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">GPT Project</span></h1>
          <p className="text-lg text-zinc-300 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-white drop-shadow-md">Our Vision</h2>
            ...
            <div className="flex gap-4">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-zinc-500 uppercase tracking-widest">Users</span>
              </div>
              <div className="w-px bg-white/10"></div>
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-purple-400 drop-shadow-sm">99.9%</span>
                <span className="text-xs text-zinc-500 uppercase tracking-widest">Uptime</span>
              </div>
            </div>
          </div>
        ...
        <div className="text-center bg-white/5 backdrop-blur-xl rounded-3xl p-12 border border-white/10 shadow-2xl">
          ...
          <p className="text-zinc-300 mb-8 max-w-xl mx-auto">Ready to experience the next generation of AI tools? Sign up today and get started for free.</p>
