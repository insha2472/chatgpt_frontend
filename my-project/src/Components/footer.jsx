...
const Footer = () => {
    return (
        <footer className="w-full bg-[var(--bg-primary)]/60 backdrop-blur-md border-t border-[var(--border-color)] py-10 px-8 relative z-10">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-md shadow-md"></div>
                    <span className="text-sm font-bold text-[var(--text-primary)] tracking-wide">GPT Project</span>
                </div>
